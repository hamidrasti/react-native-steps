    ...
    renderProgressBar = () => {
        ...
        if (direction === 'vertical') {
            progressBarStyle = {
                ...
                top: this.state.height / (2 * count),
                bottom: this.state.height / (2 * count),
                width: this.state.configs.separatorStrokeFinishedWidth === 0 ?
                    this.state.configs.separatorStrokeWidth :
            ...
            progressBarStyle = {
                ...
                left: this.state.width / (2 * count),
                right: this.state.width / (2 * count),
                height: this.state.configs.separatorStrokeFinishedWidth === 0 ?
                    this.state.configs.separatorStrokeWidth :
                    this.state.configs.separatorStrokeFinishedWidth,
    ...
    onCurrentPositionChanged = (position) => {
        ...
        Animated.sequence([
            ...
            Animated.parallel([
                Animated.timing(
                    this.sizeAnim,
                    {toValue: this.state.configs.currentStepIndicatorSize, duration: 100}
                ),
                Animated.timing(
                    this.borderRadiusAnim,
                    {toValue: this.state.configs.currentStepIndicatorSize / 2, duration: 100}
                )
            ])
        ]).start();
    }
